...
class ctRNNModel(BaseModelCT):
    ...
    def __init__(self,input_dims,hidden_dims,outputNN,preNN=None,NN0=None,learning_rate=0.1,update_loss=0.1,merror=1e-2):
        if preNN is None:
        ...
        outputNN = outputNN(hidden_dims['hidden_dim_t'],g=g,ginv=ginv)
        super().__init__(odernn,outputNN,preNN,NN0,hidden_dims,input_dims,learning_rate,update_loss,merror)
...
class ctGRUModel(BaseModelCT):
    ...
    def __init__(self,input_dims,hidden_dims,outputNN,preNN=None,NN0=None,learning_rate=0.1,update_loss=0.1,merror=1e-2):
        ...
        super().__init__(odernn,gaussianNN,preNN,NN0,hidden_dims,input_dims,learning_rate,update_loss,merror)
...
class neuralJumpModel(BaseModelCT): # need a new forward mode!
    ...
    def __init__(self,input_dims,hidden_dims,outputNN,preNN=None,NN0=None,learning_rate=0.1,update_loss=0.1,merror=1e-2):
        ...
        ctjumpnn = torchctrnn.neuralJumpODECell(jumpnn,odenet,input_size_update,
                                                tol={'atol':1e-2,'rtol':1e-2},dt_scaler=dt_scaler)
        gaussianNN = outputNN(hidden_dims['hidden_dim_t'],g=g,ginv=ginv)
...
class resNeuralJumpModel(BaseModelCT):
    ...
    def __init__(self,input_dims,hidden_dims,outputNN,preNN=None,NN0=None,learning_rate=0.1,update_loss=0.1,merror=1e-2):
        ...
        ctjumpnn = torchctrnn.neuralJumpODECell(jumpnn,odenet,input_size_update,tol={'atol':1e-2,'rtol':1e-2},dt_scaler=dt_scaler)
        gaussianNN = outputNN(hidden_dims['hidden_dim_x'],g=g,ginv=ginv)
        super().__init__(ctjumpnn,gaussianNN,preNN,NN0,hidden_dims,input_dims,learning_rate,update_loss,merror)
...
class IMODE(BaseModelCT):
    ...
    def __init__(self,input_dims,hidden_dims,outputNN,preNN=None,NN0=None,learning_rate=0.1,update_loss=0.1,merror=1e-2):
        ...
        self.hidden_dim_x = hidden_dims['hidden_dim_x']
        ...
        ctjumpnn = torchctrnn.neuralJumpODECell(jumpnn,odenet,None,tol={'atol':1e-2,'rtol':1e-2},dt_scaler=dt_scaler)
...
class dtRNNModel(BaseModelDT):
    ...
    def __init__(self,input_dims,hidden_dims,outputNN,preNN=None,NN0=None,learning_rate=0.1,update_loss=None):
        if preNN is None:
            input_size_update = input_dims['input_dim_t']
        else:
            input_size_update = hidden_dims['hidden_dim_t']        
        rnn = nn.RNNCell(input_size_update,hidden_dims['hidden_dim_t'])
        gaussianNN = GaussianOutputNN(hidden_dims['hidden_dim_t'],g=g,ginv=ginv)
